  ...
  >
    <div className="w-full h-full flex items-center justify-center absolute top-0 z-20">
      <div className="flex flex-col mx-8">
        <p className="text-6xl font-headline font-semibold leading-none text-black mb-3">Thinc.</p>
        <p className="text-6xl font-headline font-semibold leading-none text-gray-600 mb-3">Make</p>
        <p className="text-6xl font-headline font-semibold leading-none text-gray-600 mb-3">Impact</p>
