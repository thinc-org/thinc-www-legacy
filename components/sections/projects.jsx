            ...
            <div className="w-full flex items-stretch flex-col lg:flex-row mb-20">
                ...
                <div className="flex w-full lg:w-1/3 mb-3 lg:mb-0">
                    <Card className="bg-gray-100">
                        ...
                        <p className="text-base font-normal text-gray-600 leading-relaxed">
                            Do you suffer from ordering Starbucks? Maybe your beverage name is too
                            long? Starbario, the LINE bot, helps make your ordering process easier!
                ...
                <div className="flex w-full lg:w-1/3">
                    <Card className="bg-gray-100">
                        ...
                        <p className="text-base font-normal text-gray-600 leading-relaxed">
                            Reg Chula is one of the best platform on the Internet. Open Registration
