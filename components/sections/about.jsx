            ...
            <div className="flex w-full md:w-1/3 mb-3 md:mb-0">
                <Card className="bg-white">
                    <div className="flex flex-row md:flex-col lg:flex-row items-baseline mb-5">
                        ...
                        <p className="text-xl font-headline font-medium text-purple-600">
            ...
            <div className="flex w-full md:w-1/3 mb-3 md:mb-0">
                <Card className="bg-white">
                    <div className="flex flex-row md:flex-col lg:flex-row items-baseline mb-5">
                        ...
                        <p className="text-xl font-headline font-medium text-orange-600">
            ...
            <div className="flex w-full md:w-1/3">
                <Card className="bg-white">
                    <div className="flex flex-row md:flex-col lg:flex-row items-baseline mb-5">
                        ...
                        <p className="text-xl font-headline font-medium text-blue-600">
                            Career Exploration
                        </p>
                    </div>
                    <p className="text-base font-normal text-gray-600 leading-relaxed">
