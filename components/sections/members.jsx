...
const Members = () => {
  ...
  useEffect(() => {
    (async function fetchAPI() {
      const data = await (
        await fetch(`https://api.github.com/orgs/thinc-org/public_members`)
      ).json();
          ...
          <div className="w-full flex items-center flex-col">
            <div className="w-full md:w-2/3 mb-20">
              ...
              <p className="text-base text-center font-normal leading-relaxed">
                <span className="font-bold">Thinc.</span> is community consisted
                of more than 100 members. All members displayed are public
                members from our GitHub organization.
              </p>
            </div>
